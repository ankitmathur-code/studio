...
export function LyricsSection({ track }: LyricsSectionProps) {
  const lyrics = track.lyricsOrNotes || "Lyrics coming soon.";
  const notes = track.linerNotes || "No liner notes provided for this track.";
  ...
  return (
    <section className="w-full max-w-4xl mx-auto py-12 px-6 animate-fade-in opacity-0" style={{ animationDelay: '0.6s' }}>
      <Tabs defaultValue="lyrics" className="w-full">
        ...
        <TabsContent value="lyrics" className="mt-8 p-8 music-glass rounded-2xl min-h-[300px]">
          <div className="space-y-6 text-center text-lg leading-relaxed font-body whitespace-pre-line text-foreground/90">
            {lyrics}
          </div>
        </TabsContent>
        <TabsContent value="notes" className="mt-8 p-8 music-glass rounded-2xl min-h-[300px]">
          <div className="space-y-6">
            <h4 className="text-2xl font-headline text-primary uppercase tracking-tight font-bold">The Story Behind the Track</h4>
